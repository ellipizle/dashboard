...
export class HeaderComponent implements OnInit {
	...
	rangeList = [
		{ label: 'Last 5 minutes', short: '5m', start: 0, end: 0 },
		{ label: 'Last 15 minutes', short: '15m', start: 0, end: 0 },
		{ label: 'Last 30 minutes', short: '30m', start: 0, end: 0 },
		{ label: 'Last 1 hour', short: '1h', start: 0, end: 0 },
		{ label: 'Last 3 hours', short: '3h', start: 0, end: 0 },
		{ label: 'Last 6 hours', short: '6h', start: 0, end: 0 },
		{ label: 'Last 12 hours', short: '12h', start: 0, end: 0 },
		{ label: 'Last 24 hours', short: '24h', start: 0, end: 0 },
		{ label: 'Last 2 days', short: '2d', start: 0, end: 0 }
	];
