...
@Directive({
	selector: '[appCenterMenu]'
})
export class CenterMenuDirective {
	...
	@Input('appCenterMenu') private menuTrigger: MatMenuTrigger;
	...
	private _setOverlayPosition(dropDown: HTMLElement, overlayPositionBox: HTMLElement) {
		...
		this._renderer.setStyle(overlayPositionBox, 'top', this.buttonBottom + 2 + 'px');
